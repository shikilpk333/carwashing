...
class _SplashScreenState extends State<SplashScreen> implements SplashView {
  ...
  final Color overlayBoxColor = const Color.fromARGB(26, 33, 43, 100);
  ...
  void _initializePresenter() {
    ...
    final repository = SplashRepository(model);
    _presenter = SplashPresenter(view: this, repository: repository);
    
    // Delay for splash screen duration
    Future.delayed(const Duration(seconds: 2), () {
      if (mounted) {
        _presenter.checkAuthAndNavigate();
      }
    });
  }
  ...
  void showError(String message) {
    ...
    // Show error snackbar and navigate to login
